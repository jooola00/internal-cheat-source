...
void ImGui::StyleColorsClassic(ImGuiStyle* dst)
{
	...
	colors[ImGuiCol_TextDisabled] = ImVec4(0.60f, 0.60f, 0.60f, 1.00f); //yo that source is from android
...
// Exported using binary_to_compressed_c.cpp source from android
//-----------------------------------------------------------------------------
